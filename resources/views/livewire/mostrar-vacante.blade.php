<div class="p-10">
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 p-4 m-10">

            <p class="font-bold text-sm uppercase text-white my-3">Empresa:
                <span class="normal-case font-normal"> {{$vacante->empresa}} </span>
            </p>

            <p class="font-bold text-sm uppercase text-white my-3">Ultimo dia:
    ...
    @guest
        <div class="mt-5 border border-radius border-solid p-5 text-center">
            <p class="text-white">
                Deseas postularte a esta vacante? <a class="font-bold text-indigo-600"  href="{{ route('register') }}">Obten una cuenta y aplica a esta vacante!</a>
            </p>
        </div>
    @endguest
